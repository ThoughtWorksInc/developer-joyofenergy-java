...
public class PricePlanFixture {
    ...
    public static final PricePlan DEFAULT_PRICE_PLAN = new PricePlan(
            SECOND_BEST_PLAN_ID,
            "energy-supplier",
            BigDecimal.TWO,
    ...
    public static final PricePlan WORST_PRICE_PLAN = new PricePlan(
            WORST_PLAN_ID,
            null,
            BigDecimal.TEN,
            Collections.emptyList()
    ...
    public static final PricePlan BEST_PRICE_PLAN = new PricePlan(
            BEST_PLAN_ID,
            null,
            BigDecimal.ONE,
            Collections.emptyList()
